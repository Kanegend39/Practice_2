...
class Layer(QtWidgets.QMainWindow):
    ...
    def yes_vector(self):
        ...
        epsilons = np.array([epsilon_1, epsilon_2, epsilon_3])
        d_i = np.array([d])
        X, Y, E_x, E_y, E_z, E_x_T_, E_y_T_, E_z_T_, E_x_R_, E_y_R_, E_z_R_ = \
            gaussian_beam_propagation_vector(left, right, step, z, w, d_i, epsilons, 1)
